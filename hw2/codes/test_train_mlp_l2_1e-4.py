...
# 模型
linear_model = nn.models.Model_MLP([784,600,10], 'ReLU', lambda_list=[1e-4, 0])
...
runner.train([train_imgs, train_labs], [valid_imgs, valid_labs], 
             num_epochs=40, log_iters=50, save_dir='./saved_models',save_name='mlp_l2_1e-4.pickle')

# 绘图并保存
_, axes = plt.subplots(1, 2, figsize=(12, 5))
plot(runner, axes)
os.makedirs('./figs', exist_ok=True)
plt.savefig('./figs/mlp_l2_1e-4.png', dpi=300, bbox_inches='tight')
plt.show()