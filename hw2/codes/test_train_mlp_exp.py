...
scheduler = nn.lr_scheduler.ExponentialLR(optimizer, gamma=0.99999)
...
runner.train([train_imgs, train_labs], [valid_imgs, valid_labs], 
             num_epochs=40, log_iters=50, save_dir='./saved_models',save_name='mlp_exp.pickle')

_, axes = plt.subplots(1, 2, figsize=(12, 5))
plot(runner, axes)
os.makedirs('./figs', exist_ok=True)
plt.savefig('./figs/mlp_exp.png', dpi=300, bbox_inches='tight')
plt.show()