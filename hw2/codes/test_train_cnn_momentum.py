...
optimizer = nn.optimizer.Momentum(init_lr=0.01, model=model, mu=0.9)
...
runner.train(
    ...
    save_name='cnn_momentum.pickle'
)

_, axes = plt.subplots(1, 2, figsize=(12, 5))
plot(runner, axes)
os.makedirs('./figs', exist_ok=True)
plt.savefig('./figs/cnn_momentum.png', dpi=300, bbox_inches='tight')
plt.show()